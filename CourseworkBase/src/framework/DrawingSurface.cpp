	...
	if ((pFont != NULL) && (pFont->getTTFFont() != NULL))
	{
		...
		for (int x = 0; x < sText->w; x++)
		{
			for (int y = 0; y < sText->h; y++)
			{
				...
				switch (SDL_GetPixelFormatDetails(sText->format)->bits_per_pixel)
				{
				case 8:
