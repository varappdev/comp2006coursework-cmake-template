...
void BouncingBallMain::virtSetupBackgroundBuffer()
{
	...
	SimpleImage im1 = ImageManager::get()->getImagebyURL("resources/demo.png", true/*Load*/, true/*Keep it loaded*/);
...
#if 0
	// Load the image file into an image object - at the normal size
	SimpleImage im2 = ImageManager::get()->getImagebyURL("resources/demo.png", true/*Load*/, true/*Keep it loaded*/);
...
{
	// I put a mouse event handler into one of the balls, so we need to ensure that objects are told about mouse events.
...
{
	drawForegroundString( 150, 10, "Example text", 0xffffff, getFont( "resources/Cornerstone Regular.ttf", 48) );
}
