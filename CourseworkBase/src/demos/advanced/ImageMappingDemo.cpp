...
int ImageMappingDemo::virtInitialiseObjects()
{
	...
	MappableImageObject* ob = new MappableImageObject(this, 50, 50, this, "resources/demo.png", false);
	ob->setTransparencyColour(ob->getPixelColour(0,0));
	storeObjectInArray(0, ob );

	ob = new MappableImageObject(this, 250, 250, this, "resources/demo.png", false);
	ob->setTransparencyColour(ob->getPixelColour(0, 0));
	...
	ob = new MappableImageObject(&rotator, 450, 450, this, "resources/demo.png", false);
	ob->setTransparencyColour(ob->getPixelColour(0, 0));
	storeObjectInArray(2, ob);

	ob = new MappableImageObject(&shifter1, 250, 450, this, "resources/demo.png", false);
	ob->setTransparencyColour(ob->getPixelColour(0, 0));
	storeObjectInArray(3, ob);

	ob = new MappableImageObject(&shifter2, 450, 250, this, "resources/demo.png", false);
	ob->setTransparencyColour(ob->getPixelColour(0, 0));
