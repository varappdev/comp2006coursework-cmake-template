...
int DraggingDemo::virtInitialiseObjects()
{
	...
	storeObjectInArray(3, new DragableImageObject(200, 400, this, "resources/demo.png", false));
	storeObjectInArray(4, new ImageObject(400, 400, this, "resources/demo.png", false));
