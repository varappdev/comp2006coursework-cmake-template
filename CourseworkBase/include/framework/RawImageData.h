...
public:
	...
	static int getXForRotationAndCrop(int iImageWidth, int iX, int iY, int iRotation, int iCropLeft, int iCropTop)
	{
		...
		case 1:
			return iY + iCropTop;
		case 2:
			return iImageWidth - 1 - iX - iCropLeft;
		case 3:
			return iImageWidth - 1 - iY - iCropTop;
		}
	}
	...
	static int getYForRotationAndCrop(int iImageHeight, int iX, int iY, int iRotation, int iCropLeft, int iCropTop)
	{
		...
		default:
			return iY + iCropTop;
		case 1:
			return iImageHeight - 1 - iCropLeft - iX;
		case 2:
			return iImageHeight - 1 - iY - iCropTop;
		case 3:
			return iX + iCropLeft;
		}
	}
	...
	bool loadImage(std::string strFileName, int num90degRotations = 0, int cropTop = 0, int cropBottom = 0, int cropLeft = 0, int cropRight = 0, bool cacheSurface = false)
	{
		...
		if (loadedSurface != nullptr)
		{
			...
			SDL_Surface *tempSurface = SDL_CreateSurface(
				loadedSurface->w, loadedSurface->h, SDL_PIXELFORMAT_ARGB8888);
			...
			m_pImagesurface = SDL_CreateSurface(m_iWidth, m_iHeight, SDL_PIXELFORMAT_ARGB8888);
			if (m_pImagesurface == nullptr)
			{
